  ...
  return (
    <Section title="about">
      <p className="text-sm text-slate-600 transition-colors group-hover:text-black dark:text-gray-mid dark:group-hover:text-white">
        i have many interests across software and engineering, including: full-stack development, applied machine learning, computer vision, and mlops. outside of building systems, i also have a strong interest in mathematics, specifically calculus and the theory that supports machine learning and data-driven models.
      </p>
      <p className="text-sm text-slate-600 transition-colors group-hover:text-black dark:text-gray-mid dark:group-hover:text-white">
