...
export function SqlIcon({ className, size = 16 }: { className?: string; size?: number | string }) {
  return (
    <span
      className={cn("inline-block shrink-0", "[filter:brightness(0)] dark:[filter:brightness(0)_invert(1)]", className)}
    ...
    >
      ...
      >
      <defs>
        <radialGradient id="sql-b" cx="9.36" cy="10.57" fx="9.36" fy="10.57" r="7.07" gradientTransform="matrix(73.03125 0 0 37.1875 29.797 56.535)">
        ...
        <linearGradient id="sql-a" gradientUnits="userSpaceOnUse" x1="2.59" y1="10.16" x2="15.41" y2="10.16" gradientTransform="scale(7.11111)">
      ...
      <path style={{ stroke: "none", fillRule: "nonzero", fill: "url(#sql-a)" as const }} d="M64 36.55c-25.172 0-45.582-7.109-45.582-16.495v87.89c0 9.032 20.055 16.356 44.941 16.5H64c25.172 0 45.582-7.113 45.582-16.5v-87.89c0 9.172-20.41 16.496-45.582 16.496Zm0 0" />
